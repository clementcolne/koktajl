...
<head>
    ...
    <!-- Title -->
    <title>Koktajl - Cocktail Blog | Créer un compte</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="contact-form-area">
                        <form action="../assets/functions/creer-un-compte.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    <?php
                                      if(isset($_GET['erreurCompte'])) {
                                        echo "
                                          <div class='text-center' style='color:red;'>" . $_GET['erreurCompte'] . "</div></br>
                                        ";
                                      }
                                    ?>
                                ...
                                <div class="col-12 text-center">
                                  <p></br>Déjà un comte ? <a href="../connexion/">Connectez-vous</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
